...
(function ($) {
    "use strict";
    function copiaSetDotRating(element, value) {
        ...
        if (max != null)
        {
            ...
            this.click(function (e) {
                ...
                if (target.attr("id") !== $(this).attr("id")) {
                    copiaSetDotRating($(this), $(this).children(".ss-dot").index(target) + 1);
                } else {
                    copiaSetDotRating($(this), 0);
                }
            });
        }
