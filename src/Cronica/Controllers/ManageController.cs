...
namespace Cronica.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public IActionResult LinkLogin(string provider)
        {
            ...
            ApplicationUser usuario = _userManager.GetUserAsync(User).Result;
            var properties = _signInManager.ConfigureExternalAuthenticationProperties(provider, redirectUrl, usuario.Id);
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            ApplicationUser usuario = await _userManager.GetUserAsync(User);
            var info = await _signInManager.GetExternalLoginInfoAsync(usuario.Id);
            if (info == null)
            {
